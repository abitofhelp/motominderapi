...
func NewAuthService(authenticated bool, roles map[enumerations.AuthorizationRole]bool) (*AuthService, error) {
...
func (authService *AuthService) IsAuthorized(role enumerations.AuthorizationRole) bool {
	return authService.Roles[enumerations.AdminAuthorizationRole]
}
