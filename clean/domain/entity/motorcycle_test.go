...
func TestMotorcycleMake_FordIsInvalid(t *testing.T) {
	...
	// ACT
	_, err := NewMotorcycle("Ford", "Falcon", 2006, "01234567890123456")
...
func TestMotorcycleMake_HondaIsValid(t *testing.T) {
	...
	// ACT
	_, err := NewMotorcycle("Honda", "Shadow", 2006, "01234567890123456")
...
func TestMotorcycleMake_NotEmpty(t *testing.T) {
	...
	// ACT
	_, err := NewMotorcycle("", "Falcon", 2006, "01234567890123456")
...
func TestMotorcycleMake_LengthLTE20(t *testing.T) {
	...
	// ACT
	_, err := NewMotorcycle("0123456789012345678901234", "Falcon", 2006, "01234567890123456")
...
func TestMotorcycleModel_NotEmpty(t *testing.T) {
	...
	// ACT
	_, err := NewMotorcycle("Honda", "", 2006, "01234567890123456")
...
func TestMotorcycleModel_LengthLTE20(t *testing.T) {
	...
	// ACT
	_, err := NewMotorcycle("Honda", "0123456789012345678901234", 2006, "01234567890123456")
...
func TestMotorcycleYear_LT1999(t *testing.T) {
	...
	// ACT
	_, err := NewMotorcycle("Honda", "Shadow", 1998, "01234567890123456")
...
func TestMotorcycleYear_1999(t *testing.T) {
	...
	// ACT
	_, err := NewMotorcycle("Honda", "Shadow", 1999, "01234567890123456")
...
func TestMotorcycleYear_2020(t *testing.T) {
	...
	// ACT
	_, err := NewMotorcycle("Honda", "Shadow", 2020, "01234567890123456")
...
func TestMotorcycleYear_GT2020(t *testing.T) {
	...
	// ACT
	_, err := NewMotorcycle("Honda", "Shadow", 2021, "01234567890123456")
...
func TestMotorcycle_ChangeFieldValueAndValidate_Successful(t *testing.T) {
	...
	// ARRANGE
	motorcycle, err := NewMotorcycle("Honda", "Shadow", 2006, "01234567890123456")
...
func TestMotorcycleVin_GT17Characters(t *testing.T) {
	...
	// ACT
	_, err := NewMotorcycle("Honda", "Shadow", 2021, "012345678901234567")
...
func TestMotorcycleVin_LT17Characters(t *testing.T) {
	...
	// ACT
	_, err := NewMotorcycle("Honda", "Shadow", 2021, "0123456789012345")
